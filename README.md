...
2. #### Optimized time and space
   ...
   Not only does the new structure make it easier to retrieve only the relevant data and save storage, it also makes getting collective much easier.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The user is redirected to the home page</td>
      <td>Pass</td>
      <td>25/07/2022</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>19</td>
      <td>As a traveler who likes reminiscing, I want to be able to find my previous trips based on name so that I can find particular memories easier</td>
  ...
  <tbody>
    ...
    <tr>
      <td colspan="3">
        ...
        <p>&nbsp;&nbsp; ➔&nbsp;&nbsp; Conducting tests and debugging</p>
        <br>
      </td>
    </tr>
    <tr>
...
| 6. | Programming for Milestone 1 | 24 May - 30 May | 15                  | 15                  | User signup and Authentication page programming<br>Integrating Frontend and Backend |
...
| 5.  | Sorting out the backend so each user can only see his/her/their own trips | 11 Jun - 15 Jun 2022 | 30                  | 0                    | Had to restructure the entire backend while following tutorials on making app for a note making app |
| 6.  | Cleaning code and making the UI easier to work with                       | 16 Jun 2022          | 2                   | 10                   | Changed the icons, buttons and formatting |
| 7.  | Restructuring database to make it more linear                             | 16 Jun - 20 Jun 2022 | 2                   | 2                    | Discussed about the testing and readme file |
| 8.  | Adding google maps and google login                                       | 16 Jun - 18 Jun 2022 | 10                  | 0                    | Had some problems adding them due to version issues |
| 9.  | Making profile and watching tutorials for social media app                | 18 Jun - 19 Jun 2022 | 15                  | 0                    |         |
| 10. | Working on Readme and interface                                           | 20 Jun - 24 Jun 2022 | 0                   | 10                   |         |
| 11. | debugging problems with local setup, making changes in forms              | 15 Jun - 26 Jun 2022 | 3                   | 45                   | Orbitee 2 could not install the required software in her laptop and was having connectivity and hardware issues |
...
| 3.  | Added constants for primary colors used in app      | 5 July 2022          | 0                   | 3                    | Added constants for the colors and replaced the new constants everywhere in the code. |
...
| 5.  | Adding images to profile page                       | 6 Jul - 10 Jul 2022  | 0                   | 20                   | This feature is still buggy and we faced lot of run time errors while trying to add edit image option.  |
| 6.  | Fixed some bugs in updating and post                | 10 Jul 2022          | 4                   | 0                    | The update changed the data entirely instead of just updating the field, making bugs appear.  |
| 7.  | Got the public trips, the public locations and the journals visible in profile page | 10 Jul - 18 Jul 2022 | 37 | 0 |  |
| 8.  | Edited the UI for profile page                      | 19 Jul - 22 Jul 2022 | 17                  | 0                    | The widgets for the profile page were not settling down properly and we kept getting renderFlex and incorrect parent widget errors. In the process of fixing these bugs, we learnt a lot about flutter widgets. This knowledge helped a lot when we got similar while building explore page |
| 9.  | Made explore page show profiles of all users and connected it to their profile page | 22 Jul - 24 Jul 2022 | 29 | 0 | Had to edit the rules in database for this one, still haven’t found the right way to write the rules but thankfully, the code doesn’t allow users to edit what they shouldn’t |
| 10. | Fixed bugs in uploading image                       | 21 Jul - 24 Jul 2022 | 3                   | 0                    | We can now upload a profile picture but since the storage for images is not ready, the image goes away as soon as we move to another page |
| 11. | Added the option of following other people and seeing their profiles in feed | 24 Jul - 25 Jul 2022 | 13 | 0 | Had some trouble figuring out how to merge data from different collections |
...
| 16. | Manual Blackbox Testing                             | 25 July 2022         | 3                   | 2                    |         |
